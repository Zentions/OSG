...
QT_MOC_LITERAL(3, 23, 15), // "treeItemChanged"
QT_MOC_LITERAL(4, 39, 14), // "QStandardItem*"
QT_MOC_LITERAL(5, 54, 4), // "item"
QT_MOC_LITERAL(6, 59, 28), // "treeItem_CheckActionTriggerd"
QT_MOC_LITERAL(7, 88, 8) // "QAction*"

    },
    "TreeView\0stateChanged\0\0treeItemChanged\0"
    "QStandardItem*\0item\0treeItem_CheckActionTriggerd\0"
    "QAction*"
};
...
static const uint qt_meta_data_TreeView[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QString, QMetaType::Int, QMetaType::Int, QMetaType::Bool,    2,    2,    2,    2,
...
void TreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stateChanged((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< bool(*)>(_a[4]))); break;
        case 1: _t->treeItemChanged((*reinterpret_cast< QStandardItem*(*)>(_a[1]))); break;
        case 2: _t->treeItem_CheckActionTriggerd((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TreeView::*_t)(QString , int , int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TreeView::stateChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void TreeView::stateChanged(QString _t1, int _t2, int _t3, bool _t4)
{
